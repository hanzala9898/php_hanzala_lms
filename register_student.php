...
if (isset($_POST['submit'])) {
    ...
    $query =  "insert into students (name,email,phone,address,parent_contact, date) value ('$name','$email','$phone','$address','$parent_contact','$date')";

    if (mysqli_query($conn, $query)) {
        header('location: view_all_students.php?status=registered');
    } else {
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form method="POST" action="">
                    ...
                    <input class="form-control mb-3" type="text" name="phone" placeholder="Enter Phone">
                    <input class="form-control mb-3" type="text" name="address" placeholder="Enter Address">
                    <input class="form-control mb-3" type="text" name="parent_contact" placeholder="Enter Parent Contact">
                    <input class="form-control mb-3" type="date" name="date" placeholder="Enter Date">
